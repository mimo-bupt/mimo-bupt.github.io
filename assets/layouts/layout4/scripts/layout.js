...
var Layout = function() {
    ...
    var handleSidebarMenu = function() {
        ...
        if (App.isAngularJsApp()) {
            ...
            //   var $page-content = $('.page-content');                             // Cache selection
            //   $('.page-sidebar li.nav-item').removeClass('active open');                // Update links
            //   $(this).parent().addClass('active open');
            //   $('.page-base').remove();                                 // Remove content
            ...
            //       $page-content.append('<div id="load">Loading</div>');      // Load message
            //     },
            //     complete: function() {                                  // Once finished
            //       $('#load').remove();                                  // Clear message
            //     },
            //     success: function(data) {                               // Show content
            //       $page-content.html( $(data).find('.page-base') ).hide().fadeIn(400);
            //     },
        ...
        $('.page-sidebar').on('click', ' li > a.ajaxify', function(e) {
            ...
            var pageContentBody = $('.page-content .page-base');
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    App.stopPageLoading();
                    pageContent.html( $(res).find('.page-base') ).hide().fadeIn(400);
                    if((url==='luxiang1.html')||(url==='luxiang3.html')||(url==='luxiang2.html')){
                        $.getScript('../assets/global/plugins/video5/js/video.min.js')
                    }
                   if (url==='kewai1.html') {
                        $.getScript('../assets/global/plugins/changejs/js/change.js')
                   }
